...
test('GET Listing', async () => {
  await request.get('/v0/Listing')
    ...
    .then((res) => {
      ...
      expect(res.body[0].content).toStrictEqual({"Category": "Vehicles", "Location": "San Jose, CA", "image": "https://res.cloudinary.com/dfjqgstje/image/upload/v1638399746/maxresdefault_ou9lch.jpg", "price": "200000", "title": "Expensive Car"});
...
test('GET /searchSub', async () => {
  await request.get('/v0/searchSub?search=medium&subCategory=Powersport%20Vehicles')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .expect('Content-Type', /json/)
    .then((res) => {
...
test('GET /location', async () => {
  await request.get('/v0/location?search=Medium&subCategory=Powersport%20Vehicles&category=Vehicles&location=Santa%20Cruz%2C%20CA')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .expect('Content-Type', /json/)
    .then((res) => {
...
test('GET /location1', async () => {
  await request.get('/v0/location?subCategory=Powersport%20Vehicles&category=Vehicles&location=Santa%20Cruz%2C%20CA')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .expect('Content-Type', /json/)
    .then((res) => {
...
test('GET /specificFilter1', async () => {
  await request.get('/v0/specificFilter?category=Vehicles&subCategory=Powersport%20Vehicles&minPrice=10&maxPrice=100000')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .expect('Content-Type', /json/)
    .then((res) => {
...
test('GET /specificFilter2', async () => {
  await request.get('/v0/specificFilter?category=Vehicles&subCategory=Powersport%20Vehicles&minPrice=100000&maxPrice=10')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(404)
});

test('GET /specificFilter3', async () => {
  await request.get('/v0/specificFilter?category=Vehicles&subCategory=Powersport%20Vehicles&minPrice=10')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .then((res) => {
      expect(res).toBeDefined();
...
test('GET /specificFilter4', async () => {
  await request.get('/v0/specificFilter?category=Vehicles&subCategory=Power%20sport%20Vehicles&maxPrice=10')
    .set('Authorization', 'bearer ' + 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imp1YW5sZWVAZ21haWwuY29tIiwicm9sZSI6ImFkbWluIiwiaWF0IjoxNjM4NjcyMDI0LCJleHAiOjE2NDA0NzIwMjR9.B98-dZ7OlqbYncMfhnrUaBQoCq-qHPA1Y6f3n8u7cdc')
    .expect(200)
    .then((res) => {
      expect(res).toBeDefined();
